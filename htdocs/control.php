...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['action'] == 'edit') {
        ...
        $db->query('UPDATE users SET sex = "'.$_POST['sex'].'", description = "'.mysql_real_escape_string($_POST['description']).'", website = "'.mysql_real_escape_string($_POST['website']).'" WHERE id = '.mysql_real_escape_string($_SESSION['id'])) or die(sqlError(__FILE__, __LINE__));
